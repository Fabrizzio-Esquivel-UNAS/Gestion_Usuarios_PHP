...
if(isset($_POST['login'])){
	...
	$query-> bindParam(':v1', $_POST['dni'], PDO::PARAM_STR);
	$query-> bindParam(':v2', $_POST['password'], PDO::PARAM_STR);
	$query-> execute();
	$result=$query->fetch(PDO::FETCH_OBJ);
	if($query->rowCount()!==0){
		$_SESSION['dni']=$result->dni;
		$_SESSION['privileges']=$result->privilegios;
					...
					<div class="col-md-6 col-md-offset-3">
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post">
									<label for="" class="text-uppercase text-sm">DNI</label>
									<input type="tel" placeholder="DNI de usuario" name="dni" class="form-control mb" required>
